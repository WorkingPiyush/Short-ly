...
function Footer() {
    return (
        <div className='grid grid-cols-1 md:grid-cols-3 sm:gap-3 items-center text-center w-full py-6 px-6 md:py-6 border-y border-zinc-800 dark:bg-black text-black dark:text-white mt-4'>
