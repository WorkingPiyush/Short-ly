...
function ShorturlResult({ shortUrl }) {
    ...
    return (
        <div className='mt-5 flex justify-around rounded-xl bg-linear-to-r from-emerald-500/10 to-emerald-400/5 border border-emerald-400/20 text-emerald-300 font-medium shadow-[0_0_20px_rgba(16,185,129,0,0.15)] text-center text-sm md:text-xl p-4 w-full max-w-xl animate-slide-down'>
