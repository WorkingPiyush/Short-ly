...
function ProfilePopUp({ userInfo, logout, showpopup }) {
    ...
    return (
        <div className='z-100 max-h-60 h-full w-80 text-black flex flex-col gap-3 bg-white dark:bg-black dark:text-white absolute top-12 right-0 rounded-sm shadow dark:shadow-white shadow-black '>
